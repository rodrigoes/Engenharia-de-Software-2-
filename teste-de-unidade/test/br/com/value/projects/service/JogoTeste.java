...
public class JogoTeste {
	...
	//Teste para validar se o nome do participante tem menos de 12 caracteres.
	@Test
	public void VerificaQuantidadeDeCaracteres() {
		
		Participante jair = new Participante("Jair");
		int NumeroCaracteres = 12;
		assertEquals(true,jair.getNome().length()<= NumeroCaracteres);
	}
